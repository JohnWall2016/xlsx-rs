...
use zip::crc32::Crc32Reader;
use zip::compression::CompressionMethod;
use zip::spec;
...
use zip::types::{ZipFileData, System};
use zip::cp437::FromCp437;
    ...
    let mut result = ZipFileData
    {
        ...
        last_modified_time: {
            if last_mod_time == 0 || last_mod_date == 0 {
                ...
                try!(::time::Tm::from_msdos(MsDosDateTime::new(last_mod_time, last_mod_date)))
            }
        }, 
        crc32: crc32,
